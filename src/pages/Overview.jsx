...
import { portfolioSummary as ps, categoryAllocation } from '../data/portfolio';
...
const columns = [
  ...
  { key: 'pct', label: '% Portfolio', align: 'right', render: (_, row) => {
    const pct = ((row.value / ps.totalValue) * 100).toFixed(1);
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-[#94a3b8] text-sm mt-1">Vista general de todas las inversiones</p>
      </div>
