  ...
  for (const ast of assets) {
    ...
    if (ast.category === 'etf_fund') {
      ...
      loans.push({
        ...
        status: meta.frozen ? 'Paralizado' : (ast.status === 'active' ? 'Activo' : ast.status),
        frozen: meta.frozen === true,
        frozenSince: meta.frozenSince || null,
        paysMonthly: meta.pays_monthly !== false,
        bulletPayment: meta.bullet_payment === true,
